...
class Home(customtkinter.CTkToplevel):
    def __init__(self, bot):
        ...
        self.main_button_1 = customtkinter.CTkButton(master=self, fg_color="transparent", border_width=2, text="Close", text_color=("gray10", "#DCE4EE"), command=self.close_everything)
